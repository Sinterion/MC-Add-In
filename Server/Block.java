...
public class Block
{
    ...
    public static final Block tnt = (new BlockTNT(46)).setHardness(0.0F).setStepSound(soundSandFootstep).getIndirectPowerOutput("tnt");
    ...
    public static final Block obsidian = (new BlockObsidian(49)).setHardness(1.0F).setResistance(500.0F).setStepSound(soundStoneFootstep).getIndirectPowerOutput("obsidian");
    public static final Block torchWood = (new BlockTorch(50)).setHardness(0.0F).setLightValue(1.0F).setStepSound(soundWoodFootstep).getIndirectPowerOutput("torch");
    ...
    public static final Block oreRedstoneGlowing = (new BlockRedstoneOre(74, true)).setLightValue(0.75F).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).getIndirectPowerOutput("oreRedstone");
    ...
    public static final Block pressurePlateGold = (new BlockPressurePlateWeighted(147, "blockGold", Material.iron, 64)).setHardness(0.5F).setStepSound(soundMetalFootstep).getIndirectPowerOutput("weightedPlate_light");
    public static final Block pressurePlateIron = (new BlockPressurePlateWeighted(148, "blockIron", Material.iron, 640)).setHardness(0.5F).setStepSound(soundMetalFootstep).getIndirectPowerOutput("weightedPlate_heavy");
