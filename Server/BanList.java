...
public class BanList
{
    ...
    public void loadBanList()
    {
        if (this.fileName.isFile())
        {
            ...
            {
                MinecraftServer.getServer().func_98033_al().func_98234_c("Could not load ban list", var5);
            }
        }
    }
    ...
    public void saveToFile(boolean par1)
    {
        ...
        {
            MinecraftServer.getServer().func_98033_al().func_98234_c("Could not save ban list", var5);
        }
    }
}
